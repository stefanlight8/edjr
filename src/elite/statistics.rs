...
pub struct BankAccountStatistics {
    ...
    pub merc_coins_current: u64,
    #[serde(rename = "MercCoins_Spent_On_Engineering")]
    pub merc_coins_spent_on_engineering: u64,
    #[serde(rename = "MercCoins_Spent_On_MercGear")]
    pub merc_coins_spent_on_merc_gear: u64,
    #[serde(rename = "MercCoins_Total_Earned")]
    pub merc_coins_total_earned: u64,
    #[serde(rename = "MercCoins_Total_Spent")]
    pub merc_coins_total_spent: u64,
}
